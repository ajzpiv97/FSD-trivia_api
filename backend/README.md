...
- *Sample:* curl X -POST -H "Content-Type: application/json" -d '{"question": "What is the capital of Colombia?", "answer": "Bogota", "difficulty": 2, "category": 1}' http://127.0.0.1:5000/questions
- *Example response:* 
```
{
  "created": 26, 
...
- *Sample:* curl X http://127.0.0.1:5000/categories/1/questions
- *Example response:*
```
{
...
- *Sample:* curl -X POST http://localhost:5000/quizzes -H "Content-Type: application/json" -d '{"previous_questions": [21], "quiz_category": {"type": 1, "id": 2}}'
